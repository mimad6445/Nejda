...
const msgSchema = mongoose.Schema({
    emergencyType: {
        type: String,
        enum: ['حريق','حادث مرور','حالة مرضية','انتحار','إنتحار','فيضانات','البحث عن مفقود','اختطاف','إختطاف','تحت التهديد','التهديد الإلكتروني','جريمة قتل','سرقة','تهديد','تهريب','جرائم إلكترونية','إعتداء','اعتداء'],
        required: true
    },
    msg : {type : String},
